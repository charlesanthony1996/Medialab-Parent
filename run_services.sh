...
CMD1="cd '$FLASK_APP_DIR/AI_API-Wrapper/openai_backend' && nodemon --exec python3 llm_backend.py"
CMD2="cd '$FLASK_APP_DIR/AI_Filter/filter' && nodemon --exec python3 twitterRoberta.py"
CMD3="cd '$FLASK_APP_DIR/AI_Server/server' && nodemon --exec python3 server.py"
